...
function minutesUsedOnLibraryDay(list: UserReservation[], ymd: string): number {
  let sum = 0;
  for (const r of list) {
      ...
      try {
        ...
        if (!cancelled) {
          ...
          setSt1WeightAvailError(
            e instanceof Error
              ? e.message
              : "Could not load table availability.",
          );
        }
      }
    };
  ...
  return (
    <>
      <Dialog open={submitting}>
        ...
        >
          <DialogHeader>
            <DialogTitle className="flex items-center gap-3 pr-0">
              <Loader2
            ...
            <DialogDescription>
              Sending your confirmation. This may take a few seconds while we
              email your verification code to your account.
            </DialogDescription>
          </DialogHeader>
        </DialogContent>
      </Dialog>
        ...
        <Card>
            ...
            <CardDescription>
              ...
              {selectedTable ? (
                <span className="text-muted-foreground">
                  {" "}
                  · Floor {selectedTable.library_floor} ·{" "}
          ...
          <CardContent className="space-y-4">
            <p className="text-xs text-muted-foreground">
              ...
              <span className="font-medium text-foreground">30-minute</span>{" "}
              slots. Each account may hold at most{" "}
              <span className="font-medium text-foreground">4 hours</span> of
              active bookings per calendar day in that timezone.
            </p>
              ...
              >
                ...
                {st1WeightAvailError ? (
                  ...
                  <p className="mt-1 text-muted-foreground">
                    ...
                    ({LIBRARY_TIMEZONE}). The display at the table uses the same
                    value.
                  </p>
                ) : (
                  <p className="mt-1 text-muted-foreground">
                    No reservation is active on this table at the moment
                    (library clock). If the table still shows occupied, it may
                    be walk-in seating without a booking end time.
                  </p>
                )}
              </div>
            ) : null}
            ...
            <p className="text-sm text-muted-foreground">
              ...
              / {RESERVATION_MAX_MINUTES_PER_DAY} minutes. After this booking
              you would have{" "}
              <span
                className={
                  remainingAfter < 0
